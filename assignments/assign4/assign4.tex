...
%Let us instead regard entities as separate crucial parts of the system, in this
%case bits of code, giving us the following 

%Therefore, in an attempt to do something meaningful for this exercise, let us define
%an entity as a ``crucial part of the system'', thereby giving us the following
