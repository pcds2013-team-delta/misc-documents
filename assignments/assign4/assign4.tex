...
as they did not expect this tone to have seriously offended anybody.
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\textwidth/4*3]{../graphs/sequence_diagram.jpg}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\textwidth/4*3]{../graphs/architecture_01.jpg}
...
documented through Javadoc-style comments, why it seems silly to repeat that information
here.
...
\begin{itemize}
	...
	\item We have to establish a continuous delivery pipeline.
...
Besides these, the customer had no further critical topics to discuss.
